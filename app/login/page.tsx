...
function LeftPanel() {
  return (
    <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-gray-950 p-10">
      <span className="text-white text-base font-semibold tracking-tight">fedscout</span>
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex flex-1 flex-col justify-center px-6 py-12 lg:px-16">
        <div className="lg:hidden mb-8">
          <span className="text-base font-semibold tracking-tight text-gray-900">fedscout</span>
        </div>

        <div className="w-full max-w-sm mx-auto space-y-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Welcome back</h1>
            <p className="mt-1 text-sm text-gray-500">Sign in to your FedScout account</p>
          </div>

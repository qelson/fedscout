...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed bottom-5 right-5 z-50 flex h-10 w-10 items-center justify-center rounded-full border border-slate-700 bg-slate-800 shadow-lg hover:bg-slate-700 transition-colors"
    >
      {isDark ? (
